package Demo111ThreadPool.Demo1.MyThreadPool;

import Demo111ThreadPool.Demo1.MyWork.MyWork;
...
//核心
    ...
    public MyThreadPool(int corePoolSizee, int maxSize, int workSize) {
        this.corePoolSizee = corePoolSizee;
